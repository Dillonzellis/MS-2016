...
<p style="color:#1D1D1D; background-color: #E2F000; font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif'; font-size: 20px; padding-top: 10px;" align="center">UPDATE:  Appointments no longer required. Starting November 29, 2021, the branch<br>located in the 10 Peachtree building will be open Monday through Friday from 9am to 4:30pm. <br>The branch will close for lunch daily between 12:30pm and 1:30pm.</p>	
...
<div class="callout accoutSignIn">    <div class="accoutSignInWrap paddingContainer">
        ...
        <div class="accountSignInDropDown">
            <div class="paddingContainer">
<form action="https://eteller.mutualsavingscu.org/Centryx/servlet/com.sos.webteller.accountaccess.DoLogin" name="pgLogin" id="" method="post">                    <div class="validation-messages"></div>
...
<div class="callout block-on-mobile" style="width:235px;">
    <div class="paddingContainer">
         ...
         <span class="center-on-mobile"><a href ="#" target="_blank" id="loanappLink" onclick="postLink('https://eteller.mutualsavingscu.org/Centryx/servlet/com.sos.webteller.WebTellForms?Page=signup'); return false;">Online Banking Sign Up</a><br><a href="assets/framework/pages/home-banking-instructions.php" title="Home Banking Instructions">Online Banking Instructions</a><br><a href="https://eteller.mutualsavingscu.org/Centryx/servlet/com.sos.webteller.accountaccess.ForgotPassword" title="Reset Password">Reset Password</a></span><!--<br />-->
    ...
    <div class="paddingContainer">
        ...
        <form method="post" name="pgLogin" action="https://eteller.mutualsavingscu.org/Centryx/servlet/com.sos.webteller.accountaccess.DoLogin" target="_top" autocomplete="off">                   
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation">
						<tr><td><input placeholder="User ID" name="AcctNum" type="text" width="10" aria-label="ID" /></td>
							<td><input placeholder="Password" name="Pin" type="password" width="10" aria-label="Pass" /></td>
						<td><input tabIndex="3" value="Login" type="submit" name="btnOK" aria-label="Login"></td></tr>
			</table>
...
<div id="accoutSignInMobile">    <div class="accoutSignInWrap paddingContainer">
        ...
        <div class="accountSignInDropDown">
            <div class="paddingContainer">
<form method="post" name="pgLogin" action="https://eteller.mutualsavingscu.org/Centryx/servlet/com.sos.webteller.accountaccess.DoLogin" target="_top" autocomplete="off">                    <div class="validation-messages"></div>
                    <div class="paddingBot10">
...
<div class="clearBoth"></div><hr class="green" />
...
<p>       
 Don't leave money on the table. MSCU has great loan rates. <a href="/assets/framework/pages/loan-rates.php" title="Click here">Click here</a> for rates and terms. <a href="/assets/framework/pages/share-rates.php" title="Click here">Click here</a> for dividend rates.</p><p>&nbsp;</p>    
